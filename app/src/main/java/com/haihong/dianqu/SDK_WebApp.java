...
public class SDK_WebApp extends Activity {
	...
	public static void test() {
		...
		Toast.makeText(context, "我是sdkwebapp中的函数", Toast.LENGTH_SHORT).show();
//		Intent intent = new Intent(MainActivity.this, ImageTargets.class);
//		startActivity(intent);


	}
//	public void PluginTestFunction(IWebview pWebview)
//	{
...
class WebappModeListener implements ICoreStatusListener, IOnCreateSplashView {
	...
	public void onCoreInitEnd(ICore coreHandler) {
		...
		//String appBasePath = "/apps/HelloH5old/www";
		String appBasePath = "/apps/haihongwww";
		//String appBasePath = "/apps/HYFstore";
